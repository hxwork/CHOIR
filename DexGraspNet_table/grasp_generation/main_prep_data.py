...
def main_worker(rank, world_size, args):
    ...
    # 2. Setup logging and output paths to be rank-specific
    log_dir = os.path.join("/dexmal-cr-lhp-data/xh/code/DexGraspNet_table/data/experiments", args.name, 'logs', f'rank_{rank}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', type=str, default='/dexmal-cr-lhp-data/xh/code/DexGraspNet_table/meshdata', help="Root directory for mesh data.")
