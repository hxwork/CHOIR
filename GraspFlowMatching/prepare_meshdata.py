...
Prefer stage2/DexGraspNet_table/prepare_meshdata.py when preparing training meshdata;
...
def prepare_sam3d(source_base_dir: Path, dest_base_dir: Path, video_ids=None, seq_dir_name="optimized_hoi_seq"):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Root directory for meshdata (default: stage2/.../meshdata).",
    )
