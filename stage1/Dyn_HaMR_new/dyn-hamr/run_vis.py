...
def save_meshes_all(cfg, dataset, res_dicts, dev_id, mesh_dirs, num_steps=-1):
    ...
    for res_dict, mesh_dir in zip(res_dicts, mesh_dirs):
        ...
        hand_meshes_dir = os.path.join(str(dataset.data_sources.video_dir), "hand_meshes")
        mano_params_dir = os.path.join(str(dataset.data_sources.video_dir), "mano_params")
