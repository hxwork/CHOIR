...
class Dino(torch.nn.Module):
    ...
    def __init__(
        ...
        if freeze_backbone:
            ...
            logger.warning("Unfreeze encoder w/o prune parameter may lead to error in ddp/fp16 training")
    ...
    def _forward_intermediate_layers(self, input_img, intermediate_layers, cls_token=True):
