...
class AxisLayerFK(Module):
    ...
    def forward(self, transf):
        ...
        Ra_par_tmplchd = torch.matmul(self.TMPL_R_p_a[:, self.transf_parent_mapping, ...].transpose(2, 3), self.TMPL_R_p_a)
...
@deprecated(deprecated_in="0.0.2", removed_in="0.0.3", details="This class is deprecated. Please use the new class 'AxisLayerFK' instead.")
