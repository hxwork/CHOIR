...
Step 1 – prepare_sam3d: load HOI meshes (optimized_hoi_seq), apply vertex transform,
                         write decomposed.obj + scale.json into meshdata/sam3d/.
...
REPO_ROOT = MODULE_ROOT.parents[1]  # CHOIR-upload/
...
def prepare_sam3d(source_base_dir: Path, dest_base_dir: Path, video_ids=None):
    ...
    for video_dir in tqdm(video_dirs, desc="[Step 1] preparing sam3d meshes"):
        ...
        seq_dir = video_dir / "optimized_hoi_seq"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Source root with <video_id>/optimized_hoi_seq/ (default: CHOIR output/).",
    )
    parser.add_argument(
        "--video_id",
        nargs="+",
