...
Default --data_root_path is stage2/DexGraspNet_table/meshdata.
"""
import argparse
import glob
import os
...
if __name__ == '__main__':
    ...
    # experiment settings
    parser.add_argument('--data_root_path', type=str, default=DEFAULT_MESHDATA)    parser.add_argument('--object_code_list', type=str, default=None)
