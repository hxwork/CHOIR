...
def launch_job(gpus, cmd):
    ...
    # otherwise assign a GPU from the provided gpus list.
    ...
    if cuda_visible is not None:
        ...
        final_cmd = f"CUDA_VISIBLE_DEVICES={gpu} {cmd}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", default=None, help="root of data to process, default None")
    parser.add_argument("--split", default="val", help="split of dataset to process, default val")
    parser.add_argument("--gpus", nargs="*", default=[0])
    parser.add_argument("--seqs", nargs="*", default=None)
    parser.add_argument("--seq_len", type=int, default=-1)
    parser.add_argument("--use_intrins", action="store_true", help="use GT intrinsics if available")
