...
class VdieoDepthAnythingDepthModel(DepthEstimationModel):
    ...
    def __init__(self, model: str = "vitl", input_size: int = 518) -> None:
        ...
        if model == "vits":
            self.ckpt_url = "https://hf-mirror.com/depth-anything/Video-Depth-Anything-Small/resolve/main/video_depth_anything_vits.pth"
            self.use_fp32 = True
        elif model == "vitl":
            self.ckpt_url = "https://hf-mirror.com/depth-anything/Video-Depth-Anything-Large/resolve/main/video_depth_anything_vitl.pth"
            self.use_fp32 = False
        else:
