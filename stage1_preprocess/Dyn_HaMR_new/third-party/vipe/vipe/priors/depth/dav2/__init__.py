...
class DepthAnythingDepthModel(DepthEstimationModel):
    ...
    def __init__(self, model: str = "vitl", ckpt: str = "default") -> None:
        ...
        if ckpt == "default":
            ...
            self.max_depth = None
            self.ckpt_url = f"https://hf-mirror.com/depth-anything/Depth-Anything-V2-{url_name}/resolve/main/depth_anything_v2_{model}.pth?download=true"

        elif ckpt == "metric-indoor":
            self.is_metric = True
            self.max_depth = 20.0
            self.ckpt_url = f"https://hf-mirror.com/depth-anything/Depth-Anything-V2-Metric-Hypersim-{url_name}/resolve/main/depth_anything_v2_metric_hypersim_{model}.pth?download=true"

        elif ckpt == "metric-outdoor":
            self.is_metric = True
            self.max_depth = 80.0
            self.ckpt_url = f"https://hf-mirror.com/depth-anything/Depth-Anything-V2-Metric-VKITTI-{url_name}/resolve/main/depth_anything_v2_metric_vkitti_{model}.pth?download=true"
