...
The right-hand source sequence is aligned to the left-hand base sequence by
estimating a per-frame rigid transform between the two object meshes.
"""
...
DEFAULT_LEFT_SEQ = Path("rendering_for_paper/ours_SelfCaptured/IMG_5295")
DEFAULT_RIGHT_SEQ = Path("rendering_for_paper/ours_SelfCaptured/IMG_5296")
DEFAULT_OUTPUT_SEQ = Path("rendering_for_paper/ours_SelfCaptured/IMG_5295_5296_two_hands")
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--left_seq", type=Path, default=DEFAULT_LEFT_SEQ, help="Left-hand/object base sequence directory.")
    parser.add_argument("--right_seq", type=Path, default=DEFAULT_RIGHT_SEQ, help="Right-hand/object source sequence directory.")
    parser.add_argument("--output_seq", type=Path, default=DEFAULT_OUTPUT_SEQ, help="Output two-hand sequence directory.")
