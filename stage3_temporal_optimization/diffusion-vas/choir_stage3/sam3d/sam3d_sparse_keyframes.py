...
def run_sam3d_rotation_dense_from_mask_onset(
    *,
    ...
    out_dir = os.path.join(output_path, "stage3", "diagnostics", "sam3d_sparse_keyframes", "rotation_dense")
...
def run_sam3d_sparse_keyframes_motion_window(
    *,
    ...
    n_raw = len(raw_rgbs_np)
    out_dir = os.path.join(output_path, "stage3", "diagnostics", "sam3d_sparse_keyframes")
    os.makedirs(out_dir, exist_ok=True)
    cfg = config_path or SAM3D_CONFIG_PATH
