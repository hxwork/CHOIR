...
from eval_common.mesh import Mesh
...
class MANODecimator:
    ...
    def __init__(self):
        data = np.load("./data/arctic_data/data/meta/mano_decimator_195.npy", allow_pickle=True).item()
        mydata = {}
...
_DEFAULT_MANO_DIR = "../../stage1_preprocess/Dyn_HaMR_new/_DATA/data/mano/"
_LOCAL_MANO_DIR = "../../stage1_preprocess/Dyn_HaMR_new/_DATA/data/mano"
MODEL_DIR = os.environ.get("MANO_MODEL_DIR") or (_DEFAULT_MANO_DIR if os.path.exists(_DEFAULT_MANO_DIR) else _LOCAL_MANO_DIR)
